    ...
    fn view(&self) -> Html {
        html! {
            <Container wrap=Wrap::Wrap
                ...
                <div class="badge">
                    <p>
                        <a href="https://crates.io/crates/vedas_ui" target="_blank"><img alt="Crate Info" src="https://img.shields.io/badge/yew__styles-framework%20styles-brightgreen"/></a>
                        <a href="https://docs.rs/vedas_ui/" target="_blank"><img alt="API Docs" src="https://img.shields.io/badge/yew__styles-docs-informational"/></a>
                        ...
                        <a href="https://github.com/spielrs/vedas_ui/blob/master/LICENSE-MIT.md" target="_blank"><img alt="License" src="https://img.shields.io/badge/License-MIT%2FApache--2.0-lightgrey"/></a>
                ...
                <Item layouts=vec!(ItemLayout::ItXl(8), ItemLayout::ItM(10), ItemLayout::ItXs(12))>
                    ...
                    <ol>
                        ...
                        <li>{"Add the yew_style crate with the features needed for your project in Cargo.toml file: "}<br/>
                            <code>{"vedas_ui = {version=\"0.9\", features=[\"layouts\",\"button\"]}"}</code>
                        </li>
                ...
                <Item layouts=vec!(ItemLayout::ItXl(8), ItemLayout::ItM(10), ItemLayout::ItXs(12))>
                    ...
                    <p>{"If you need a feature that is not cover yet, as soon as possible, you can also fund the issue "}<a href="https://issuehunt.io/r/spielrs/vedas_ui">{"here"}</a></p>
                </Item>
                <Item layouts=vec!(ItemLayout::ItXl(8), ItemLayout::ItM(10), ItemLayout::ItXs(12))>
                    <h2>{"Code of Conduct"}</h2>
                    <p>{"Please check our "}<a href="https://github.com/spielrs/vedas_ui/blob/master/CODE_OF_CONDUCT.md" target="_blank">{"code of conduct"}</a></p>
                </Item>
                <Item layouts=vec!(ItemLayout::ItXl(8), ItemLayout::ItM(10), ItemLayout::ItXs(12))>
                ...
                <Item layouts=vec!(ItemLayout::ItXl(8), ItemLayout::ItM(10), ItemLayout::ItXs(12))>
                    <h2>{"License"}</h2>
                    <p>{"Yew Style is "}<a href="https://github.com/spielrs/vedas_ui/blob/master/LICENSE-MIT.md" target="_blank">{"MIT"}</a>
                    {" and "}<a href="https://github.com/spielrs/vedas_ui/blob/master/LICENSE-APACHE.md" target="_blank">{"Apache-2.0"}</a>{" licensed"}</p>
                </Item>
            </Container>
        }
    }
